...
while True:
    ...
    # ==========================================
        ...
        policias.append(nuevo_policia)

        print("\nEfectivo registrado correctamente.")


    # ==========================================
    # REGISTRAR AGENTE DE SERENAZGO
    # ==========================================
        ...
        serenos.append(nuevo_sereno)

        print("\nAgente registrado correctamente.")


    # ==========================================
    # MOSTRAR EFECTIVOS POLICIALES
    # ==========================================
